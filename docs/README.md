...
| [../MIGRATION-GUIDE.md](../MIGRATION-GUIDE.md) | Section design-token migration |
| [../scripts/MIGRATION.md](../scripts/MIGRATION.md) | Supabase data seed script |
...
Obsolete or historical docs: **[docs/archive/](./archive/)** — Vite SPA audits, Sanity draft, one-off session reports. Do not link from README or agent instructions.