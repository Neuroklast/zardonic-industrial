...
// ---------------------------------------------------------------------------
// Pre-generate a scrypt hash for password 'password' to use in login tests
let SCRYPT_HASH_OF_PASSWORD: string
beforeAll(async () => {
  SCRYPT_HASH_OF_PASSWORD = await hashPassword('password')
})
