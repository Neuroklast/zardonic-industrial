...
const translations: Record<string, Record<string, string>> = {
  ...
  'section.media':             { en: 'Media', de: 'Medien', ru: 'Медиа', it: 'Media', es: 'Media', pt: 'Media', ja: 'メディア', ko: '미디어' },
  ...
  'gigs.noEvents':             { en: 'No upcoming events.', de: 'Keine bevorstehenden Events.', ru: 'Нет предстоящих событий.', it: 'Nessun evento in programma.', es: 'No hay eventos próximos.', pt: 'Sem eventos próximos.', ja: '今後のイベントはありません。', ko: '예정된 이벤트가 없습니다.' },
  ...
  // ── Media downloads ─────────────────────────────────────────────────
  'media.empty':               { en: 'Downloads coming soon', de: 'Downloads folgen in Kürze', ru: 'Загрузки скоро', it: 'Download in arrivo', es: 'Descargas pronto', pt: 'Downloads em breve', ja: 'ダウンロード近日公開', ko: '다운로드 준비 중' },
  'media.viewAll':             { en: 'View All Downloads ({0})', de: 'Alle Downloads anzeigen ({0})', ru: 'Все загрузки ({0})', it: 'Vedi tutti i download ({0})', es: 'Ver todas las descargas ({0})', pt: 'Ver todos os downloads ({0})', ja: 'すべてのダウンロード ({0})', ko: '모든 다운로드 ({0})' },
  'media.download':            { en: 'Download', de: 'Download', ru: 'Скачать', it: 'Scarica', es: 'Descargar', pt: 'Descarregar', ja: 'ダウンロード', ko: '다운로드' },
  'media.categoryAll':         { en: 'All', de: 'Alle', ru: 'Все', it: 'Tutti', es: 'Todos', pt: 'Todos', ja: 'すべて', ko: '전체' },
  'media.categoryPhoto':       { en: 'Photos', de: 'Fotos', ru: 'Фото', it: 'Foto', es: 'Fotos', pt: 'Fotos', ja: '写真', ko: '사진' },
  'media.categoryLogo':        { en: 'Logos', de: 'Logos', ru: 'Логотипы', it: 'Loghi', es: 'Logos', pt: 'Logótipos', ja: 'ロゴ', ko: '로고' },
  'media.categoryDocument':    { en: 'Documents', de: 'Dokumente', ru: 'Документы', it: 'Documenti', es: 'Documentos', pt: 'Documentos', ja: '資料', ko: '문서' },
  'media.categoryAudio':       { en: 'Audio', de: 'Audio', ru: 'Аудио', it: 'Audio', es: 'Audio', pt: 'Áudio', ja: 'オーディオ', ko: '오디오' },
  'media.categoryOther':       { en: 'Other', de: 'Sonstiges', ru: 'Другое', it: 'Altro', es: 'Otros', pt: 'Outros', ja: 'その他', ko: '기타' },
  ...
  'newsletter.pendingConfirm': { en: 'Check your email to confirm your subscription.', de: 'Bitte bestätige deine Anmeldung über den Link in deiner E-Mail.', ru: 'Подтвердите подписку по ссылке в письме.', it: 'Conferma l\'iscrizione tramite il link nell\'email.', es: 'Confirma tu suscripción con el enlace del correo.', pt: 'Confirma a subscrição através do link no email.', ja: 'メールのリンクから登録を確認してください。', ko: '이메일의 링크로 구독을 확인해 주세요.' },
  'newsletter.success':        { en: "You're subscribed. Thank you.", de: 'Du bist angemeldet. Danke!', ru: 'Вы подписаны. Спасибо!', it: 'Iscrizione confermata. Grazie!', es: 'Suscripción confirmada. Gracias.', pt: 'Subscrição confirmada. Obrigado.', ja: '登録が完了しました。ありがとうございます。', ko: '구독이 완료되었습니다. 감사합니다.' },
  ...
  'newsletter.consentPrefix':  { en: 'I agree to receive emails and accept the', de: 'Ich stimme dem Erhalt von E-Mails zu und akzeptiere die', ru: 'Я согласен получать письма и принимаю', it: 'Accetto di ricevere email e accetto la', es: 'Acepto recibir correos y la', pt: 'Aceito receber emails e a', ja: 'メールの受信と', ko: '이메일 수신에 동의하며' },
  'newsletter.consentLink':    { en: 'privacy policy', de: 'Datenschutzerklärung', ru: 'политику конфиденциальности', it: 'informativa sulla privacy', es: 'política de privacidad', pt: 'política de privacidade', ja: 'プライバシーポリシー', ko: '개인정보 처리방침' },
  'newsletter.unsubscribeConfirm': { en: 'Unsubscribe', de: 'Abmelden', ru: 'Отписаться', it: 'Annulla iscrizione', es: 'Darse de baja', pt: 'Cancelar subscrição', ja: '登録解除', ko: '구독 취소' },
  'newsletter.unsubscribePrompt': { en: 'Click below to unsubscribe from the mailing list.', de: 'Klicke unten, um dich von der Mailingliste abzumelden.', ru: 'Нажмите ниже, чтобы отписаться от рассылки.', it: 'Clicca qui sotto per annullare l\'iscrizione.', es: 'Haz clic abajo para darte de baja.', pt: 'Clica abaixo para cancelar a subscrição.', ja: '下のボタンで登録を解除できます。', ko: '아래 버튼을 눌러 구독을 취소하세요.' },
  'newsletter.unsubscribeSuccess': { en: 'You have been unsubscribed.', de: 'Du wurdest abgemeldet.', ru: 'Вы отписаны от рассылки.', it: 'Iscrizione annullata.', es: 'Te has dado de baja.', pt: 'Subscrição cancelada.', ja: '登録を解除しました。', ko: '구독이 취소되었습니다.' },
  'newsletter.confirmSuccessTitle': { en: 'SUBSCRIPTION CONFIRMED', de: 'ANMELDUNG BESTÄTIGT', ru: 'ПОДПИСКА ПОДТВЕРЖДЕНА', it: 'ISCRIZIONE CONFERMATA', es: 'SUSCRIPCIÓN CONFIRMADA', pt: 'SUBSCRIÇÃO CONFIRMADA', ja: '登録が確認されました', ko: '구독이 확인되었습니다' },
  'newsletter.confirmSuccess': { en: "You're subscribed. Thank you — watch your inbox for news and releases.", de: 'Du bist angemeldet. Danke — halte Ausschau nach News und Releases in deinem Postfach.', ru: 'Вы подписаны. Спасибо — следите за новостями и релизами в почте.', it: 'Iscrizione confermata. Grazie — controlla la posta per news e uscite.', es: 'Suscripción confirmada. Gracias — revisa tu correo para noticias y lanzamientos.', pt: 'Subscrição confirmada. Obrigado — fica atento ao email para novidades e lançamentos.', ja: '登録が完了しました。ニュースとリリース情報をお楽しみに。', ko: '구독이 완료되었습니다. 뉴스와 릴리즈 소식을 기대해 주세요.' },
  'newsletter.confirmFailedTitle': { en: 'CONFIRMATION FAILED', de: 'BESTÄTIGUNG FEHLGESCHLAGEN', ru: 'ОШИБКА ПОДТВЕРЖДЕНИЯ', it: 'CONFERMA NON RIUSCITA', es: 'CONFIRMACIÓN FALLIDA', pt: 'CONFIRMAÇÃO FALHOU', ja: '確認に失敗しました', ko: '확인 실패' },
  'newsletter.confirmFailed': { en: 'Confirmation failed. Please try again.', de: 'Bestätigung fehlgeschlagen. Bitte versuche es erneut.', ru: 'Не удалось подтвердить. Попробуйте снова.', it: 'Conferma non riuscita. Riprova.', es: 'La confirmación falló. Inténtalo de nuevo.', pt: 'A confirmação falhou. Tenta novamente.', ja: '確認に失敗しました。もう一度お試しください。', ko: '확인에 실패했습니다. 다시 시도해 주세요.' },
  'newsletter.confirmMissingToken': { en: 'Missing confirmation token. Please use the link from your email.', de: 'Bestätigungslink fehlt. Bitte nutze den Link aus deiner E-Mail.', ru: 'Отсутствует токен подтверждения. Используйте ссылку из письма.', it: 'Token di conferma mancante. Usa il link nell\'email.', es: 'Falta el token de confirmación. Usa el enlace del correo.', pt: 'Token de confirmação em falta. Usa o link do email.', ja: '確認トークンがありません。メールのリンクを使用してください。', ko: '확인 토큰이 없습니다. 이메일의 링크를 사용하세요.' },
  'newsletter.unsubscribeTitle': { en: 'UNSUBSCRIBE', de: 'ABMELDEN', ru: 'ОТПИСКА', it: 'ANNULLA ISCRIZIONE', es: 'DARSE DE BAJA', pt: 'CANCELAR SUBSCRIÇÃO', ja: '登録解除', ko: '구독 취소' },
  'newsletter.unsubscribeInvalid': { en: 'Invalid unsubscribe link. Please use the link from a newsletter email.', de: 'Ungültiger Abmeldelink. Bitte nutze den Link aus einer Newsletter-E-Mail.', ru: 'Недействительная ссылка отписки. Используйте ссылку из письма рассылки.', it: 'Link di annullamento non valido. Usa il link da un\'email della newsletter.', es: 'Enlace de baja no válido. Usa el enlace de un correo del newsletter.', pt: 'Link de cancelamento inválido. Usa o link de um email da newsletter.', ja: '無効な登録解除リンクです。ニュースレターメールのリンクを使用してください。', ko: '유효하지 않은 구독 취소 링크입니다. 뉴스레터 이메일의 링크를 사용하세요.' },
  'newsletter.backHome': { en: 'Back to home', de: 'Zur Startseite', ru: 'На главную', it: 'Torna alla home', es: 'Volver al inicio', pt: 'Voltar ao início', ja: 'ホームに戻る', ko: '홈으로 돌아가기' },
