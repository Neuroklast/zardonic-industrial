...
export const SECTION_REGISTRY: SectionRegistryEntry[] = [
  ...
  },
  {
    ...
    configFields: [
      ...
      {
        path: 'instagram.enabled',
        label: 'Enable Instagram Feed',
        type: 'toggle',
        defaultValue: false,
        description: 'Pull images automatically from your Instagram Basic Display API feed.',
        disclosure: 'advanced',
      },
      {
        path: 'instagram.accessToken',
        label: 'Instagram Access Token',
        type: 'text',
        placeholder: 'IGQ…',
        description: 'Long-lived Instagram Basic Display API access token. Keep this secret.',
        disclosure: 'advanced',
      },
      {
        path: 'instagram.maxImages',
        label: 'Max Instagram Images',
        type: 'number',
        min: 1,
        max: 50,
        placeholder: '12',
        description: 'Maximum number of Instagram images to display.',
        disclosure: 'advanced',
      },
    ],
  },
